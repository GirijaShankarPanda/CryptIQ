...
# Step 1: Load ChainLink dataset
df = pd.read_csv('Dataset/coin_ChainLink.csv', parse_dates=['Date'])
...
# Step 7: Train Final Model using XGBRegressor with best params from SimpleGBM
...
joblib.dump(final_model, 'models/best_xgboost_chainlink_model.pkl')
print("\nModel saved to models/best_xgboost_chainlink_model.pkl")
...
plt.title('ChainLink Price Prediction: Actual, Predicted (Train), and Future Prices')
plt.xlabel('Date')
