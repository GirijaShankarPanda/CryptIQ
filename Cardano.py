...
# Step 1: Load Cardano dataset
df = pd.read_csv('Dataset/coin_Cardano.csv', parse_dates=['Date'])
...
joblib.dump(final_model, 'models/best_xgboost_cardano_model.pkl')
print("\nModel saved to models/best_xgboost_cardano_model.pkl")
...
plt.title('Cardano (ADA) Price Prediction: Actual, Predicted (Train), and Future Prices')
plt.xlabel('Date')
