...
# --- Step 2: Load Stellar Dataset ---
df = pd.read_csv('Dataset/coin_Stellar.csv', parse_dates=['Date'])
...
joblib.dump(final_model, 'models/best_xgboost_stellar_model.pkl')
print("\nModel saved to models/best_xgboost_stellar_model.pkl")
...
plt.title('Stellar (XLM) Price Prediction: Actual, Predicted (Train), and Future Prices')
plt.xlabel('Date')
